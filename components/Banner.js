...
function Banner() {
    return (
        ...
        <div className="absolute top-1/2 w-full text-center ">
            ...
            <button className="text-purple-500 bg-white px-10 py-4 shadow-md rounded-full font-bold my-2 
            hover:shadow-xl active:scale-90 transition duration-150">I'm flexble</button>
        </div>
        </div>
    )
}
